def it_was_ok
  ...
  #
  # Movie.where(yr: 1970..1979) OIJOWEIJFOWEIJFOWIFJWEOIJF
  #
...
def directed_by_one_of(them)
  ...
  #
  # Movie.where(yr: years) LOOK AT THIS!!!!!
  #
  # Find the id and title of all the movies directed by one of 'them'.
  #them is an array of directors
